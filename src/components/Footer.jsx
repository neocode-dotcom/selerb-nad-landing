    ...
    <footer className="bg-black text-gray-400 py-12 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <div className="mt-6 space-y-2 text-sm">
              <p className="flex items-center gap-2">
                ...
                Calle Villa 139, Suite 115, Ponce PR 00730
              </p>
              <p className="flex items-center gap-2">
                <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#ingredientes" className="hover:text-blue-400 transition-colors">Ingredientes</a></li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm">
            © 2026 Selerb NAD+ por A Lo Natural. Todos los derechos reservados.
          </p>
